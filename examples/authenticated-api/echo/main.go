...
import (
	...
	"github.com/gerhardwagner/oapi-codegen/v2/examples/authenticated-api/echo/api"
	"github.com/gerhardwagner/oapi-codegen/v2/examples/authenticated-api/echo/server"
