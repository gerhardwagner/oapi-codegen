...
// URL components (http://gerhardwagner.com/schemas/document.json#/Foo) are supported if they present in --import-mapping
...
// ./local/file.yml                                     -> true
// http://gerhardwagner.com/schemas/document.json             -> true
// http://gerhardwagner.com/schemas/document.json#/Foo        -> false
